...
// registers the callbacks and then calls `rcli_run_main`, the same entry the
// CMake `rcli-cxx` binary uses.
//
...
// published Swift distribution. In this monorepo, set RCLI_SDK_SWIFT_PATH to
